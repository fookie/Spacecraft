...
public class WeaponSlot {
	...
	public static boolean displayweapon(SpaceShip s){
		...
		if(s.w1.weaponID == 0){
			MainGame.test.repainter.add_nooffset_element("Images//InGameHUD//Weaponslot//hightech.png",MainGame.test.repainter.onscreenx(0), MainGame.test.repainter.onscreeny(-MainGame.test.windowsizey+360), 0, 2);
			...
			MainGame.test.repainter.add_nooffset_element("Images//InGameHUD//Weaponslot//rocket.png",MainGame.test.repainter.onscreenx(0), MainGame.test.repainter.onscreeny(-MainGame.test.windowsizey+360), 0, 2);
			...
			MainGame.test.repainter.add_nooffset_element("Images//InGameHUD//Weaponslot//burst.png",MainGame.test.repainter.onscreenx(0), MainGame.test.repainter.onscreeny(-MainGame.test.windowsizey+360), 0, 2);
			...
			MainGame.test.repainter.add_nooffset_element("Images//InGameHUD//Weaponslot//mass.png",MainGame.test.repainter.onscreenx(0), MainGame.test.repainter.onscreeny(-MainGame.test.windowsizey+360), 0, 2);
